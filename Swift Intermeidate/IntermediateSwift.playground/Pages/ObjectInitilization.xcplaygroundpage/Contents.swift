...
class Person {
    ...
    /*init?(dict:[String: AnyObject]){ //failable initializer, could be nil if the data is not avaliable
...
class Vehicle {
    ...
    convenience init(){ // we need to call our destinated initilizer
...
// required Initializers -- subclass must provide inplementation
